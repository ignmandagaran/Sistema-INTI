...
//Query para cargar modulos (visibles) en select
$query_buscar_modulos= 'SELECT m.id_modulo, c.titulo_capacitacion, m.titulo_modulo, t.tema, l.localidad, m.fecha, m.hora_inicio, m.hora_fin, m.cantidad_asistentes, m.cantidad_empresas, m.usuarios, m.observaciones FROM modulos m 
...
$query_buscar_visitas= 'SELECT v.id_visita, c.cuit, tv.tipo_visita, ta.tipo_asistencia,
                     p.titulo_proyecto, v.fecha, v.fecha_fin, v.hora_inicio, v.hora_fin, v.usuarios, v.observaciones 
...
$query_buscar_capacitaciones= 'SELECT id_capacitacion, titulo_capacitacion, tipo_capacitacion, titulo_proyecto, c.fecha_inicio, c.fecha_fin, asistentes, empresas, c.observaciones 
